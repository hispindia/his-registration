...
<script type="text/javascript">
	...
	function checkAadharCardNumberrForEdit() {
		patientId = MODEL.patientId;
		aadharCardNo = jQuery("#aadharCardNo").val();
...
<form id="patientRegistrationForm" method="POST">
	<table cellspacing="0">
		<tr>
			...
			<td class="cell"><input id="patientName" name="patient.name" style="width: 300px;" /></td>
			<td class="cell"><b>ID Number * &nbsp;&nbsp; <input name="patient.identifier" size="23"
		...
		<tr>
			...
			<td class="cell">dd/mm/yyyy<br />
				<table>
					...
					<tr>
						...
						<td><input type="hidden" id="calendar" /> <input id="birthdate" name="patient.birthdate" /> <img
								id="calendarButton" src="../../moduleResources/registration/calendar.gif" /> <input
								id="birthdateEstimated" type="hidden" name="patient.birthdateEstimate" value="true" />
						</td>
			...
			<td rowspan="2" class="border">
				...
				<input id="aadharCardNo" name="patient.attribute.20" placeholder="Aadhar Card No" /
					onblur="checkAadharCardNumberrForEdit();"> <br />
				...
				<table cellspacing="10">
					...
					<tr>
						<td><input id="patCatGeneral" type="checkbox" name="person.attribute.14" value="General" />
							General</td>
						<td><input id="rsby" type="checkbox" name="person.attribute.14" value="RSBY" /> RSBY</td>
						<td><span id="rsbyField">RSBY Number <input id="rsbyNumber" name="person.attribute.11" /></span>
						</td>
					</tr>
					<tr>
						<td><input id="patCatStaff" type="checkbox" name="person.attribute.14" value="Staff" /> Staff
						</td>
						<td><input id="bpl" type="checkbox" name="person.attribute.14" value="BPL" /> BPL</td>
						<td><span id="bplField">BPL Number <input id="bplNumber" name="person.attribute.10" /></span>
						</td>
					</tr>
					...
					<tr>
						...
						<td></td>
						<td><input id="patCatAntenatal" type="checkbox" name="person.attribute.14" value="Antenatal" />
							Antenatal Patient</td>
					</tr>
					<tr>
						<td></td>
						<!-- ghanshyam 07-sept-2013 Support #2686 GUI Changes (spellings/ fonts/ alignments) -->
					...
					<tr>
						<td></td>
						<td><input id="patCatOtherFree" type="checkbox" name="person.attribute.14" value="Other Free" />
							Other Free</td>
						<!-- 17/5/2012 Marta: Add text field to capture the free category description #188 -->
						<td><span id="freeField"> <select id="freeCategory" name="person.attribute.19"
									style="width: 185px;">
								</select></span></td>
					</tr>
					<!-- ghanshyam 12-sept-2013 New Requirement #2684 Introducing a field at the time of registration to put Aadhar Card Number -->
			...
			<td class="cell">
				<table>
					<tr>
						...
						<td>
							<!-- <input id="patientPostalAddress" name="person.attribute.18" style="width: 300px;" />  -->
							<!-- 26-6-2012 Marta - to store address in the openmrs patient_address table #289-->
							<input id="patientPostalAddress" name="patient.address.postalAddress"
								style="width: 300px;" />
						</td>
					</tr>
					<tr>
						<td>District:</td>
						<td><select id="districts" name="patient.address.district" onChange="PAGE.changeDistrict();"
								style="width: 200px;">
							</select></td>
					</tr>
					<tr>
						<td>Tehsil:</td>
						<td><select id="tehsils" name="patient.address.tehsil" style="width: 200px;">
							</select></td>
					</tr>
				</table>
			</td>
		...
		<tr>
			...
			<td class="cell"><input id="patientPhoneNumber" name="person.attribute.16" style="width: 200px;" /></td>
			<td class="bottom"></td>
		</tr>
		<tr>
			<td class="cell"><b>Relative Name *</b></td>
			<td class="cell">
				<div id="patientRelativeNameSection"></div> <input id="patientRelativeName" name="person.attribute.8"
					style="width: 200px;" />
			</td>
		</tr>
		<tr>
			...
			<td colspan="3" style="padding: 0em 30em 0em 30em;">
				...
				<input type="button" value="Reset" onclick="window.location.href=window.location.href" /> </td>
