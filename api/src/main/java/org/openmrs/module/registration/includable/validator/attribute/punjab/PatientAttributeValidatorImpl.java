 ...
 *  
 **/
package org.openmrs.module.registration.includable.validator.attribute.punjab;
 ...
 * 
 * @author Thai Chuong
 * Date created <dd-mm-yy>: 05-05-2012
 * 
 * Fixed Bug#162 - Registration: Validation for RSBY and BPL
 * On redmine project: TESTING RESULT GIT PUNJAB 
 * Implement for PatientAttributeValidator for Punjab
 *
 */
public class PatientAttributeValidatorImpl implements PatientAttributeValidator {
	...
	private boolean checkBPLNumber(Patient patient, String number) {
		// There's no requirement for BPLNumber in Punjab
		return true;
	}
}
