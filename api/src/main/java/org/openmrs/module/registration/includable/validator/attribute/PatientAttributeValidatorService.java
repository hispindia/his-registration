/**
 *  Copyright 2008 Health Information Systems Project of India
 *
...
public class PatientAttributeValidatorService implements
		PatientAttributeValidator {

	private Log logger = LogFactory.getLog(getClass());

	private static PatientAttributeValidator validator = null;
	...
	public PatientAttributeValidatorService() {
		if (validator == null) {
			...
			String qualifiedName = "org.openmrs.module.registration.includable.validator.attribute."
					+ hospitalName + ".PatientAttributeValidatorImpl";
			try {
				validator = (PatientAttributeValidator) Class.forName(
						qualifiedName).newInstance();
			} catch (Exception e) {
				e.printStackTrace();
			}			
		} 
